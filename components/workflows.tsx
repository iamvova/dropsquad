        ...
        <div className="pb-12 md:pb-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
            ...
            <p 
              ...
              data-aos-easing="ease-out-quart"
            >
              Наша платформа — це зручний хаб для криптоентузіастів. Тут ви знайдете аналітику по основним активам, освітні матеріали та найсвіжіші можливості для активностей у Web3.
            </p>
          </div>
          {/* Spotlight items */}
              ...
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-linear-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-indigo-200/65">
                    Зручно трекати BTC/ETH/SOL/BNB, активності, кількість взаємодій та gwei.
                  </p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-linear-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-indigo-200/65">
                    Активності — актуальні ноди, тестнети, ретродропи.
                  </p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-linear-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-indigo-200/65">
                    Академія — гайди для новачків і досвідчених.
                  </p>
                </div>
              </div>
            </a>
